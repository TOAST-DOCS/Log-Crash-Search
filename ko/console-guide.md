...
### 이슈조회(신규)
로그 검색 페이지를 통해 개선된 Log&Crash Search 콘솔을 이용할 수 있습니다.
기본 기능은 기존 페이지와 동일합니다.
변경 사항은 아래와 같습니다.
![lcs_04_202107](https://static.toastoven.net/prod_logncrash/lcs_04_202107.png)
1. Chart 내의 Export 기능을 사용할 수 있습니다.
2. 테이블의 칼럼별 오름차순/내림차순 정렬을 적용할 수 있습니다.

![lcs_05_202107](https://static.toastoven.net/prod_logncrash/lcs_05_202107.png)
* 기존 **의견**, **히스토리** 탭을 **의견 및 히스토리** 탭 하나로 합쳐 사용자 편의성을 높였습니다.
...
개선한 Log&Crash Search 콘솔에서는 **앱 크래시 지표** 메뉴를 **크래시 리포트** 메뉴로 변경했습니다.
...
개선한 Log&Crash Search 콘솔에서는 **크래시 사용자** 메뉴를 **사용자별 이슈 조회** 메뉴로 명칭을 변경했습니다.
